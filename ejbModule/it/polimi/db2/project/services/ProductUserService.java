...
import it.polimi.db2.project.exceptions.UnreviewedException;
...
public class ProductUserService {
	 ...
	 * @throws UnreviewedException if there is a product of the day which has not been reviewed yet
	 */
	public Product getProductOfTheDay() throws NoProductOfTheDayException, UnreviewedException {
		// today's date
	 ...
	 * @throws UnreviewedException if there is an error generated by retrieving the product of the day
	 * @throws NoProductOfTheDayException if there is an error generated by retrieving the product of the day
	 */
	public List<QuestionnaireResponse> getReviewsOfTheProductOfTheDay() throws NoProductOfTheDayException, UnreviewedException{
		 ...
		 */
		Product prodDay = getProductOfTheDay();
		...
		try {
			...
			temporaryList = em.createNamedQuery("QuestionnaireResponse.GetSubmittedProductsForShowingReviewsToUsers", 
